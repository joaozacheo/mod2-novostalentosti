...
public class App9 {
    public static void main(String[] args) {
        ...
        vend1.setId(1);
        vend1.setNome("Zeinho");
        vend1.setPercComissao(2);
        vend1.setMetaVenda(2000);
        vend1.setTelefone("5555-1111");

        var vend2 = new Vendedor();
        vend2.setId(2);
        vend2.setNome("Paulinho");
        vend2.setPercComissao(3);
        vend2.setMetaVenda(1000);
        vend2.setTelefone("5555-2222");

        var vend3 = new Vendedor();
        vend3.setId(3);
        vend3.setNome("Arthurzinho");
        vend3.setPercComissao(2);
        vend3.setMetaVenda(2000);
        vend3.setTelefone("5555-3333");

        var vend4 = new Vendedor();
        vend4.setId(4);
        vend4.setNome("Fernandinha");
        vend4.setPercComissao(3);
        vend4.setMetaVenda(1000);
        ...
        geren1.setSetor("5555-6666");
        
        var geren2 = new Gerente();
        geren1.setNome("Sr. Richfield");
        geren1.setId(2);
        geren1.setSetor("Diretoria");
        geren1.setSetor("5555-7777");
